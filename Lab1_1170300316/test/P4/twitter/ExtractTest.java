...
public class ExtractTest {
	...
	/*
	@Test
	public void testMyGetMentionedUsers() {

		//Tweet t1 = new Tweet(0, "TeddyBear",
				//"@you Hello my love @Chell. @Chell! A nice @His day! My new email:tb@hotmail.com", d1);
		//Tweet t2 = new Tweet(1, "Chell", "@TeddyBear U misstake @dad me as chell. U may wanna @chell", d2);
		//Set<String> nameSet = new HashSet<String>();
		//nameSet = Extract.getMentionedUsers(Arrays.asList(t1, t2));
		...
		//assertEquals(1, 1);
		// assertEquals(false, nameSet.isEmpty());
	}
	*/
	/*
