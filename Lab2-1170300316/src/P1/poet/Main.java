...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        final GraphPoet nimoy = new GraphPoet(new File("test/P1/poet/InSolitude.txt"));
        final String input = "Feeling so tired,\nWith solitude we overcome our fear.";
        System.out.println(input + "\n>>>\n" + nimoy.GetRevisedPoet(input));
    }
