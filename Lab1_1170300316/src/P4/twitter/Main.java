...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        */
    	...
    	/*
    	Tweet t1 = new Tweet(0, "TeddyBear", "Hello my love @Chell. @Chell! A nice day! My new email:tb@hotmail.com", d1);
        Tweet t2 = new Tweet(1, "Chell", "@TeddyBear U misstake me as chell. U may wanna @chell", d2);
        Set<String> nameSet = Extract.getMentionedUsers(Arrays.asList(t1, t2));
        for(String element: nameSet) {
        	System.out.println(element);
        }
        */
    	// String test = "I dont line chell!";
